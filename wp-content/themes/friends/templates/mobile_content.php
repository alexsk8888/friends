...
echo'
            ...
            <div class="absolute">
                ...
                <div class="animation_content">
                    ...
                    <div id="el_172219" class="info_block_bottom js-bnfy">
...
$flag = true;
             if(!empty($review_video1)) {
                 $flag = false;
echo '        <video muted="true" class="background-video"  width="300" height="375" autoplay="" 
                    loop="" playsinline="" >
...
echo' <div id="frame_9" class="frame">';
...
echo     '      <video muted="" class="background-video"  width="300" height="375" autoplay="" 
                                 loop="" playsinline="" >
...
echo' <div id="frame_10" class="frame">';
...
echo '              <video muted="" class="background-video"  width="300" height="375" autoplay=""  loop="" playsinline="" >
...
echo' <div id="frame_11" class="frame">
             <div class="absolute">
                <div class="pagination">
                    <div class="tab"><div class="active white"></div></div>
                    <div class="tab"><div class="active white"></div></div>
